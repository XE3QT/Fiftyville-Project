...
UPDATE flights
SET origin_airport_id = (SELECT id FROM airports WHERE abbreviation = 'CSF')
WHERE origin_airport_id = 8;

UPDATE flights
SET destination_airport_id = (SELECT id FROM airports WHERE abbreviation = 'CSF')
WHERE destination_airport_id = 8;

SELECT f.id, f.hour, f.minute, origin.full_name AS origin_airport, destination.full_name AS destination_airport
FROM flights AS f
